...
from nnunet.network_architecture.Implementation_CODNet.Res2Net_v1b import res2net50_v1b
from torchvision.models import resnet50
from nnunet.network_architecture.Implementation_CODNet.utils import PreNorm, FeedForward, Attention
...
class Main_Net(SegmentationNetwork):
    ...
    def forward(self, x, name=None):
        ...
        output = torch.nn.functional.interpolate(output, size=(size, size))
...
if __name__ == "__main__":
    ...
    num_batchsize = 4
    size = 256
    ycbcr_image = torch.randn(4, 3, 256, 256)
