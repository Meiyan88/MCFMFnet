...
class Generic_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        self.downf1 = Upsample(scale_factor=[0.5, 0.5, 0.5], mode='trilinear')
        self.downf2 = Upsample(scale_factor=[0.5, 0.5, 0.5], mode='trilinear')
        self.downf3 = Upsample(scale_factor=[0.5, 0.5, 0.5], mode='trilinear')
        if self.upscale_logits:
