...
if __name__ == "__main__":
    network = SwinUNETR(img_size=128, in_channels=1, out_channels=2, dummy=False).cuda(5)
    x = torch.zeros((1, 1, 128, 128, 128)).cuda(5)
    # print(network)
    with torch.no_grad():
    ...
    x = torch.zeros((1, 1, 64, 64, 64), requires_grad=False).cuda(5)
